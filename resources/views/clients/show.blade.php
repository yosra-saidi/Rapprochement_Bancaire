...
<div class="sidebar">
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link" href="{{ route('factures.index') }}"><i class="fas fa-file-invoice"></i> Gestion des Factures</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('clients.index') }}"><i class="fas fa-users"></i> Gestion des Clients</a>
        </li>
        <li class="nav-item">
