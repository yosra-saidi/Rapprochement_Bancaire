    ...
    <div class="content">
        <div class="form-container">
            <form action="{{ route('transactions.store') }}" method="POST">
                ...
                <div class="form-group">
                    <label for="date_transaction">Date_Transaction</label>
                    <input type="date" id="date_transaction" name="date_transaction" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="payeur">Payeur</label>
                    <input type="text" id="payeur" name="payeur" class="form-control" required>
                </div>
                <div class="form-group">
...
<head>
    ...
    <style>
        ...
        .table-factures {
            width: 100%; /* Assure que la table prend toute la largeur de son conteneur */
        }
    </style>
</head>
<body>
